...
void IBPI_FluxInteractionRenderer_C::SetInteractionsAreaVehicle(const struct FLinearColor& Area)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BPI_FluxInteractionRenderer_C", "SetInteractionsAreaVehicle");
...
void IBPI_FluxInteractionRenderer_C::SetInteractionsTextureVehicle(class UTextureRenderTarget2D* Texture)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BPI_FluxInteractionRenderer_C", "SetInteractionsTextureVehicle");
