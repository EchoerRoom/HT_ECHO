...
void UBPL_FluidFlux_C::CheckRenderTarget(int32 Width, int32 Height, ETextureRenderTargetFormat Format, class UTextureRenderTarget2D* CurrentRenderTarget, class UObject* __WorldContext, bool* TheSame)
{
...
void UBPL_FluidFlux_C::GetEngineVersionInt(class UObject* __WorldContext, int32* Integer)
{
	static class UFunction* Func = nullptr;
...
void UBPL_FluidFlux_C::IsPointPowerOfTwo(const struct FIntPoint& Value, class UObject* __WorldContext, bool* Result)
{
	static class UFunction* Func = nullptr;
...
void UBPL_FluidFlux_C::IsValuePowerOfTwo(int32 Value, class UObject* __WorldContext, bool* Result)
{
	static class UFunction* Func = nullptr;
...
void UBPL_FluidFlux_C::RecreateRenderTarget(class UTextureRenderTarget2D* CurrentTexture, int32 Width, int32 Height, ETextureRenderTargetFormat Format, const struct FLinearColor& ClearColor, uint8 LOD, bool GenerateMipmaps, class UObject* __WorldContext, class UTextureRenderTarget2D** NewTexture)
{
	static class UFunction* Func = nullptr;
...
void UBPL_FluidFlux_C::SetRectTransform2D(class UMaterialInstanceDynamic*& Target, const struct FTransform& InTransform, class UObject* __WorldContext)
{
	static class UFunction* Func = nullptr;
...
void UBPL_FluidFlux_C::SetRenderTargetConfig(class UTextureRenderTarget2D* RenderTargetObject, ETextureFilter Filter, bool SRGB, ETextureAddress Address_X, ETextureAddress Address_Y, class UObject* __WorldContext)
{
	static class UFunction* Func = nullptr;
...
void UBPL_FluidFlux_C::SetTexture2DConfig(class UTexture2D* RenderTargetObject, ETextureFilter Filter, bool SRGB, ETextureAddress Address_X, ETextureAddress Address_Y, ETextureMipGenSettings Mip_Gen_Settings, class UObject* __WorldContext)
{
	static class UFunction* Func = nullptr;
...
void UBPL_FluidFlux_C::MakeVolumeLocalTransform(const struct FVector& ExtraSize, const struct FVector& Scale, double ZOffsetScale, class UObject* __WorldContext, struct FTransform* NewParam)
{
	static class UFunction* Func = nullptr;
...
void UBPL_FluidFlux_C::GetBordersVector(int32 StateAreaBorders, class UObject* __WorldContext, struct FLinearColor* LinearColor) const
{
	static class UFunction* Func = nullptr;
...
// (Public, HasOutParams, BlueprintCallable, BlueprintEvent, BlueprintPure, Const)
// Parameters:
// struct FBS_FluxRectBlend                StateAreaBorders                                       (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// class UObject*                          __WorldContext                                         (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash)
// struct FVector4                         ReturnValue                                            (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

struct FVector4 UBPL_FluidFlux_C::GetRectBlendParameter(const struct FBS_FluxRectBlend& StateAreaBorders, class UObject* __WorldContext) const
{
	static class UFunction* Func = nullptr;
