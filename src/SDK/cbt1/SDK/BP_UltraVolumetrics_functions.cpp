...
void ABP_UltraVolumetrics_C::FogQualityMinusGridPixelSize(class FString* Output)
{
	static class UFunction* Func = nullptr;
	...
	Params::BP_UltraVolumetrics_C_FogQualityMinusGridPixelSize Parms{};
...
void ABP_UltraVolumetrics_C::FogQualityMinusGridSizeZ(class FString* Output)
{
	static class UFunction* Func = nullptr;
	...
	Params::BP_UltraVolumetrics_C_FogQualityMinusGridSizeZ Parms{};
