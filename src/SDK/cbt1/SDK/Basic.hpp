...
namespace Offsets
{
	constexpr int32 GObjects          = 0x0A6BA760;
	constexpr int32 AppendString      = 0x011C36C0;
	constexpr int32 GNames            = 0x0A603200;
	constexpr int32 GWorld            = 0x0A8454A8;
	constexpr int32 ProcessEvent      = 0x013DBAF0;
