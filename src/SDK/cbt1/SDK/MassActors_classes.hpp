...
public:
	...
	uint8                                         Pad_1F6A[0x88];                                    // 0x0068(0x0088)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_1F6B[0x28];                                    // 0x0038(0x0028)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_1F6C[0x80];                                    // 0x00A8(0x0080)(Fixing Size After Last Property [ Dumper-7 ])
	struct FMassEntityConfig                      EntityConfig;                                      // 0x0128(0x0030)(Edit, ContainsInstancedReference, Protected, NativeAccessSpecifierProtected)
	uint8                                         Pad_1F6D[0x2C];                                    // 0x0158(0x002C)(Fixing Size After Last Property [ Dumper-7 ])
	struct FMassNetworkID                         NetID;                                             // 0x0184(0x0004)(Net, RepNotify, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
{
public:
	uint8                                         Pad_1F6E[0x10];                                    // 0x0038(0x0010)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_1F6F[0x30];                                    // 0x0150(0x0030)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_1F70[0x7];                                     // 0x0029(0x0007)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_1F71[0x7];                                     // 0x0031(0x0007)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_1F72[0x2A0];                                   // 0x00E0(0x02A0)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_1F73[0x2A0];                                   // 0x00E0(0x02A0)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_1F74[0x2A0];                                   // 0x00E0(0x02A0)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_1F75[0x2A0];                                   // 0x00E0(0x02A0)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_1F76[0x2A0];                                   // 0x00E0(0x02A0)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_1F77[0x2A0];                                   // 0x00E0(0x02A0)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_1F78[0x2A0];                                   // 0x00E0(0x02A0)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_1F79[0x2A0];                                   // 0x00E0(0x02A0)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_1F7A[0x2A0];                                   // 0x00E0(0x02A0)(Fixing Struct Size After Last Property [ Dumper-7 ])
