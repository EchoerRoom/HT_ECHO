...
{
public:
	uint8                                         Pad_1F58[0x18];                                    // 0x02A0(0x0018)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_1F59[0x2A8];                                   // 0x00D8(0x02A8)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_1F5A[0x7E0];                                   // 0x00C0(0x07E0)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_1F5B[0x2A8];                                   // 0x00D8(0x02A8)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_1F5C[0xD28];                                   // 0x00C8(0x0D28)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_1F5D[0x4];                                     // 0x002C(0x0004)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_1F5E[0x30];                                    // 0x0038(0x0030)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_1F5F[0x30];                                    // 0x0078(0x0030)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_1F60[0x130];                                   // 0x00B8(0x0130)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	struct FMassReplicationParameters             Params;                                            // 0x0028(0x0058)(Edit, NoDestructor, NativeAccessSpecifierPublic)
