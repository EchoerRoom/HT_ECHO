...
public:
	...
	void SetDomain(const struct FVector& Location, const struct FVector& Size, const struct FIntPoint& Resolution, double PixelSize, double Param_CaptureOffset, double Width);
