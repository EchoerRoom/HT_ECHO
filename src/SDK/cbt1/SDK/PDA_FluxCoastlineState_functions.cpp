...
// double                                  Param_CaptureOffset                                    (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// double                                  Width                                                  (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void UPDA_FluxCoastlineState_C::SetDomain(const struct FVector& Location, const struct FVector& Size, const struct FIntPoint& Resolution, double PixelSize, double Param_CaptureOffset, double Width)
{
	static class UFunction* Func = nullptr;
	...
	Parms.Param_CaptureOffset = Param_CaptureOffset;
	Parms.Width = Width;
