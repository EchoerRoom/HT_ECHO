...
// struct FIntPoint                        Param_Resolution                                       (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
void UPDA_FluxSimulationState_C::SetSimulationWorld(const struct FVector& Location, const struct FVector& Size, int32 Frame, const struct FIntPoint& Param_Resolution, const struct FBS_FluxRectBlend& Blend, double DepthOffset)
{
	static class UFunction* Func = nullptr;
...
// int32                                   Param_LevelOfDetail                                    (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// bool                                    Param_Compression                                      (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void UPDA_FluxSimulationState_C::SetStateConfing(bool StaticFrame, double VelocityNormalization, double HeightNormalization, int32 Param_LevelOfDetail, bool Param_Compression)
{
	static class UFunction* Func = nullptr;
	...
	Parms.Param_LevelOfDetail = Param_LevelOfDetail;
	Parms.Param_Compression = Param_Compression;
...
// (Public, HasOutParams, BlueprintCallable, BlueprintEvent, BlueprintPure, Const)
// Parameters:
// struct FIntPoint                        Param_Resolution                                       (Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void UPDA_FluxSimulationState_C::GetTextureSize(struct FIntPoint* Param_Resolution) const
{
	static class UFunction* Func = nullptr;
	...
	if (Param_Resolution != nullptr)
		*Param_Resolution = std::move(Parms.Param_Resolution);
}
