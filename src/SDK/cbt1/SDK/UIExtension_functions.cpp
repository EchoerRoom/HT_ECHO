...
// class UObject*                          DataItem                                               (Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

void UUIExtensionPointWidget::OnConfigureWidgetForData__DelegateSignature(class UUserWidget* Widget, class UObject* DataItem)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("UIExtensionPointWidget", "OnConfigureWidgetForData__DelegateSignature");

	Params::UIExtensionPointWidget_OnConfigureWidgetForData__DelegateSignature Parms{};
...
TSubclassOf<class UUserWidget> UUIExtensionPointWidget::OnGetWidgetClassForData__DelegateSignature(class UObject* DataItem)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("UIExtensionPointWidget", "OnGetWidgetClassForData__DelegateSignature");

	Params::UIExtensionPointWidget_OnGetWidgetClassForData__DelegateSignature Parms{};
