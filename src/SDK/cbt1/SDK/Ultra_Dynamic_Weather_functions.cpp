...
// Parameters:
// class UHottaPrimaryDataAsset*           Param_Weather                                          (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash)
...
void AUltra_Dynamic_Weather_C::Apply_Max_to_Material_Effects(class UHottaPrimaryDataAsset* Param_Weather, double* Snow_Coverage, double* Wetness, double* Param_Dust)
{
	static class UFunction* Func = nullptr;
...
void AUltra_Dynamic_Weather_C::Constructionscriptfunction(bool Param_Run_By_Counterpart)
{
	static class UFunction* Func = nullptr;
...
// double                                  Param_Water_Level                                      (Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void AUltra_Dynamic_Weather_C::Get_Intended_Water_Level(bool* Using_Water_Level, double* Param_Water_Level)
{
	static class UFunction* Func = nullptr;
	...
	if (Param_Water_Level != nullptr)
		*Param_Water_Level = Parms.Param_Water_Level;
}
...
void AUltra_Dynamic_Weather_C::PlayRainSoundWithWwiseEvent()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("Ultra_Dynamic_Weather_C", "PlayRainSoundWithWwiseEvent");
...
void AUltra_Dynamic_Weather_C::Update_DLWE_Sand_Compressions()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("Ultra_Dynamic_Weather_C", "Update DLWE Sand Compressions");
