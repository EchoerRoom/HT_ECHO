...
#define IMGUI_DEFINE_FORMAT_STRING_FUNCTIONS
...
namespace ImGui
{
    ...
    IMGUI_API bool          SmallButton(const char* label, const ImVec2& size = ImVec2(0, 0)); // button with (FramePadding.y == 0) to easily embed within text
...
struct ImGuiStyle
{
    ...
    ImVec2      SelectableTextAlign;        // Alignment of selectable/menuitem text when selectable is larger than text. Defaults to (0.0f, 0.0f) (top-left aligned).
